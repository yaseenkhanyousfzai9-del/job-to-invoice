...
3. CUST-JOB-01 / S06 are VERIFIED. **S05 Jobs-list API** is **VERIFIED** (DEC-JOB-001, 2026-09-22). Next: Android **S05 Jobs list UI**, then **S08 Job overview** — by authorization only, not automatic.
...
Next unimplemented Job UI after S06: **S05 Jobs list Android** (API prerequisite VERIFIED via DEC-JOB-001). **S08 Job overview** remains deferred after that. Do not implement either automatically.
