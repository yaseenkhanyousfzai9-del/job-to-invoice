...
3. CUST-JOB-01 / S06 are VERIFIED. **S05 Jobs-list API** is **VERIFIED** (DEC-JOB-001, 2026-09-22). **S05 Jobs list UI** is **IMPLEMENTED** (awaiting physical Android verification). Next: physical S05 Jobs UI verify, then **S08 Job overview** — by authorization only, not automatic.
