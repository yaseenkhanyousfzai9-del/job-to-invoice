...
| R-CUS-PRE-05 | POST /jobs DB02 jobs | Minimum jobs table and create/list so Customer picker, associated jobs, and referenced-delete are real | S06, S19 | `jobs.customer_id` | `job_created` | Table+FK+RLS VERIFIED; list-by-customer VERIFIED (CUST-API-03); **Create Job API VERIFIED** 2026-09-21; **S06 mobile UI VERIFIED** physical Android 2026-09-22. Jobs list (S05) / Job overview (S08) not claimed | VERIFIED |
